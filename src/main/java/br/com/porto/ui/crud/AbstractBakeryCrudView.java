...
import br.com.porto.backend.service.FilterableCrudService;
import br.com.porto.ui.components.SearchBar;
import br.com.porto.ui.utils.TemplateUtil;
import br.com.porto.ui.views.HasNotifications;
...
public abstract class AbstractBakeryCrudView<E extends AbstractEntity> extends Crud<E>
    ...
    private static final String DISCARD_MESSAGE = "Há modificações que não foram salvas. Descartar modificações?";
    private static final String DELETE_MESSAGE = "Tem certeza que deseja apagar o %s selecionado? Essa ação não poderá ser desfeita.";
    ...
    public AbstractBakeryCrudView(Class<E> beanType, FilterableCrudService<E> service,
        ...
        String entityName = EntityUtil.getNameFrontEnd(beanType);
        ...
        searchBar.setActionText("Novo " + entityName);
