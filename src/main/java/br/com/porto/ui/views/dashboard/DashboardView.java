package br.com.porto.ui.views.dashboard;
...
import br.com.porto.backend.service.OrderService;
import br.com.porto.ui.MainView;
import br.com.porto.ui.dataproviders.OrdersGridDataProvider;
import br.com.porto.ui.utils.BakeryConst;
import br.com.porto.ui.utils.FormattingUtils;
import br.com.porto.ui.views.storefront.OrderCard;
import br.com.porto.ui.views.storefront.beans.OrdersCountDataWithChart;
...
public class DashboardView extends PolymerTemplate<TemplateModel> {
	...
	private void initProductSplitMonthlyGraph(Map<Paciente, Integer> productDeliveries) {
		...
		DataSeries deliveriesPerProductSeries = new DataSeries(productDeliveries.entrySet().stream()
				.map(e -> new DataSeriesItem(e.getKey().getNome(), e.getValue())).collect(Collectors.toList()));
