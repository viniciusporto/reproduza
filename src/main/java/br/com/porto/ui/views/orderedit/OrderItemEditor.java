...
import br.com.porto.ui.views.storefront.events.ProductChangeEvent;
...
public class OrderItemEditor extends PolymerTemplate<TemplateModel> implements HasValueAndElement<ComponentValueChangeEvent<OrderItemEditor,OrderItem>, OrderItem> {
	...
	@Id("products")
	private ComboBox<Paciente> products;
	...
	public OrderItemEditor(DataProvider<Paciente, String> productDataProvider) {
