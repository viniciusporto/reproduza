...
public class DashboardData {
	...
	private LinkedHashMap<Paciente, Integer> productDeliveries;
	...
	public LinkedHashMap<Paciente, Integer> getProductDeliveries() {
		return productDeliveries;
	}

	public void setProductDeliveries(LinkedHashMap<Paciente, Integer> productDeliveries) {
