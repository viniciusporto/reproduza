...
public class UserService implements FilterableCrudService<User> {
	...
	public static final String MODIFY_LOCKED_USER_NOT_PERMITTED = "Usuário bloqueado. Não pode ser modificado ou deletado";
	private static final String DELETING_SELF_NOT_PERMITTED = "Não é possível deletar a própria conta.";
