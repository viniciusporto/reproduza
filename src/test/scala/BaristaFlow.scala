...
class BaristaFlow extends Simulation {
  ...
  val productsIdExtract = regex("""node":(\d+),"type":"put","key":"payload","feat":[0-9]*,"value":\{"type":"@id","payload":"pacientes"""").saveAs("productsId")
  val products2IdExtract = regex("""payload":"pacientes.{2000,4000}node":(\d+),"type":"put","key":"payload","feat":[0-9]*,"value":\{"type":"@id","payload":"pacientes"""").saveAs("products2Id")
  ...
  val productsId3Extract = regex("""payload":"pacientes.{2000,4000}payload":"pacientes.{2000,4000}node":(\d+),"type":"put","key":"payload","feat":[0-9]*,"value":\{"type":"@id","payload":"pacientes"""").saveAs("products3Id")
